...
async function loadSession() {
    ...
    // FORMAT 2: Bmb~ (MEGA.nz)
    else if (config.SESSION_ID.startsWith("Bmb~")) {
        console.log("📥 Detected Bmb~ format session (MEGA)");
        const sessdata = config.SESSION_ID.replace("Bmb~", '');
    ...
    // Unknown format
        ...
        console.log("⚠️ Unknown SESSION_ID format. Use NOVA~ or Bmb~. QR code will be shown.");
        return false;
    }
}
